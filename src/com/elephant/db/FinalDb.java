...
import com.elephant.db.sqlite.CursorUtils;
import com.elephant.db.sqlite.DbModel;
import com.elephant.db.sqlite.ManyToOneLazyLoader;
import com.elephant.db.sqlite.OneToManyLazyLoader;
import com.elephant.db.sqlite.SqlBuilder;
import com.elephant.db.sqlite.SqlInfo;
import com.elephant.db.table.KeyValue;
import com.elephant.db.table.ManyToOne;
import com.elephant.db.table.OneToMany;
import com.elephant.db.table.TableInfo;
import com.elephant.exception.DbException;
...
public class FinalDb {
	...
	private void exeSqlInfo(SqlInfo sqlInfo) {
		if (sqlInfo != null) {
			...
			L.e(TAG, "sava error:sqlInfo is null");
		}
	}
