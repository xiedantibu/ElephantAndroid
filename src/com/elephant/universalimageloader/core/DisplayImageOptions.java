 ...
 * <li>whether stub image will be displayed in {@link android.widget.ImageView
 * ImageView} if image loading fails</li>
...
public final class DisplayImageOptions {
	...
	public static class Builder {
		...
		/**
		 * Incoming image will be displayed in {@link android.widget.ImageView
		 * ImageView} during image loading
		 * 
		 * @param imageRes
		 *            Image resource
		...
		/**
		 * Incoming image will be displayed in {@link android.widget.ImageView
		 * ImageView} during image loading. This option will be ignored if
		...
		/**
		 * Incoming image will be displayed in {@link android.widget.ImageView
		 * ImageView} if empty URI (null or empty string) will be passed to
		...
		/**
		 * Incoming image will be displayed in {@link android.widget.ImageView
		 * ImageView} if some error occurs during requested image
		 * loading/decoding.
		 * 
		 * @param imageRes
		 *            Image resource
		...
		/**
		 * Sets whether {@link android.widget.ImageView ImageView} will be reset
		 * (set <b>null</b>) before image loading start
		 */
		...
		/**
		 * Sets bitmap processor which will be process bitmaps before they will
		 * be displayed in {@link ImageView} but after they'll have been saved
		 * in memory cache.
		 */
