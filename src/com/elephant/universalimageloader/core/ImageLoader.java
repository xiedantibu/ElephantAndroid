...
import com.elephant.universalimageloader.core.assist.FlushedInputStream;
...
import com.elephant.universalimageloader.core.assist.SimpleImageLoadingListener;
import com.elephant.universalimageloader.core.display.BitmapDisplayer;
import com.elephant.universalimageloader.core.display.FakeBitmapDisplayer;
import com.elephant.universalimageloader.utils.ImageSizeUtils;
...
public class ImageLoader {
	...
	public void displayImage(String uri, ImageView imageView,
		...
		ImageSize targetSize = ImageSizeUtils.defineTargetSizeForView(
				imageView, configuration.maxImageWidthForMemoryCache,
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			if (options.shouldPostProcess()) {
				ImageLoadingInfo imageLoadingInfo = new ImageLoadingInfo(uri,
						imageView, targetSize, memoryCacheKey, options,
						listener, engine.getLockForUri(uri));
				ProcessAndDisplayImageTask displayTask = new ProcessAndDisplayImageTask(
						engine, bmp, imageLoadingInfo, options.getHandler());
			...
			ImageLoadingInfo imageLoadingInfo = new ImageLoadingInfo(uri,
					imageView, targetSize, memoryCacheKey, options, listener,
					engine.getLockForUri(uri));
			LoadAndDisplayImageTask displayTask = new LoadAndDisplayImageTask(
					engine, imageLoadingInfo, options.getHandler());
			engine.submit(displayTask);
		}
	}
	...
	public void loadImage(String uri, ImageSize targetImageSize,
		...
		fakeImage.setLayoutParams(new LayoutParams(targetImageSize.getWidth(),
				targetImageSize.getHeight()));
