 ...
 *******************************************************************************/
package com.elephant.universalimageloader.core;
...
import com.elephant.universalimageloader.cache.disc.DiscCacheAware;
import com.elephant.universalimageloader.cache.disc.impl.UnlimitedDiscCache;
import com.elephant.universalimageloader.cache.disc.naming.FileNameGenerator;
import com.elephant.universalimageloader.cache.memory.MemoryCacheAware;
import com.elephant.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.elephant.universalimageloader.core.assist.MemoryCacheUtil;
import com.elephant.universalimageloader.core.assist.QueueProcessingType;
import com.elephant.universalimageloader.core.decode.ImageDecoder;
import com.elephant.universalimageloader.core.download.ImageDownloader;
import com.elephant.universalimageloader.core.download.NetworkDeniedImageDownloader;
import com.elephant.universalimageloader.core.download.SlowNetworkImageDownloader;
import com.elephant.universalimageloader.core.process.BitmapProcessor;
import com.elephant.utils.L;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		...
		public Builder discCacheExtraOptions(int maxImageWidthForDiscCache,
				...
				int compressQuality, BitmapProcessor processorForDiscCache) {
		 ...
		 * {@link com.elephant.universalimageloader.cache.memory.impl.LruMemoryCache
		...
		public Builder memoryCacheSizePercentage(int avaialbleMemoryPercent) {
			if (avaialbleMemoryPercent <= 0 || avaialbleMemoryPercent >= 100)
				throw new IllegalArgumentException(
						"avaialbleMemoryPercent must be in range (0 < % < 100)");
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.elephant.universalimageloader.cache.disc.impl.TotalSizeLimitedDiscCache
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.elephant.universalimageloader.cache.disc.impl.FileCountLimitedDiscCache
		 ...
		 * Default value -
		 * {@link com.elephant.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link com.elephant.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.elephant.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value -
		 * {@link com.elephant.universalimageloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.elephant.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * {@link com.elephant.universalimageloader.utils.L#disableLogging()} to
