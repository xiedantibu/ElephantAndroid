 ...
 *******************************************************************************/
package com.elephant.universalimageloader.core.decode;
...
public class BaseImageDecoder implements ImageDecoder {
	 ...
	 *            match
	 *            {@link com.elephant.universalimageloader.core.ImageLoaderConfiguration.Builder#writeDebugLogs()
	...
	protected Options prepareDecodingOptions(ImageSize imageSize,
		...
		if (scaleType != ImageScaleType.NONE) {
			...
			if (loggingEnabled)
				L.d(LOG_SABSAMPLE_IMAGE, imageSize, imageSize.scaleDown(scale),
