 ...
 * <b>NOTE:</b> It's strongly recommended your {@link ImageView} has defined
 * width (<i>layout_width</i>) and height (<i>layout_height</i>) .<br />
 * <b>NOTE:</b> New {@link Bitmap} object is created for displaying. So this
 * class needs more memory and can cause {@link OutOfMemoryError}.
 * 
