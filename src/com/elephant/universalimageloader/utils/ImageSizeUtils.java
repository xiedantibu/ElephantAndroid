 ...
 *******************************************************************************/
package com.elephant.universalimageloader.utils;
...
public final class ImageSizeUtils {
	 ...
	 * 3) Get <b>maxWidth</b> and <b>maxHeight</b>. If both of them are not set
	 * then go to step #4.<br />
	 * 4) Get <b>maxImageWidth</b> param (<b>maxImageWidthForMemoryCache</b>)
	 * and <b>maxImageHeight</b> param (<b>maxImageHeightForMemoryCache</b>). If
	 * both of them are not set (equal 0) then go to step #5.<br />
	...
	public static ImageSize defineTargetSizeForView(ImageView imageView,
		...
		int width = (params != null && params.width == LayoutParams.WRAP_CONTENT) ? 0
		...
		int height = (params != null && params.height == LayoutParams.WRAP_CONTENT) ? 0
	...
	public static float computeImageScale(ImageSize srcSize,
			ImageSize targetSize, ViewScaleType viewScaleType, boolean stretch) {
		int srcWidth = srcSize.getWidth();
		int srcHeight = srcSize.getHeight();
		int targetWidth = targetSize.getWidth();
		int targetHeight = targetSize.getHeight();
